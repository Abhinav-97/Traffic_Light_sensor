...
def knn(x_train,y_train,xt,k=21):
	labels = []
	for ix in range(x_train.shape[0]):
		d = euclidean(x_train[ix],xt)
...
# Let us suppose the demo works for 10 cycles
i = 0
while i < 10:
	#random distribution of traffic over two roads
	# let us suppose there are 50 cars in the two roads
	...
	i+=1
	time.sleep(30)
	# After every 30 second the algorithm is repeated
